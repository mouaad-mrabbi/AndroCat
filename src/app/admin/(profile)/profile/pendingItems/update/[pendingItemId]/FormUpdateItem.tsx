...
import { createPendingItems, getMyPendingItem, updateMyPendingItem } from "@/apiCalls/adminApiCall";
...
export default function FormUpdatePendingItem({ pendingItemId }: pageProps) {
  ...
  useEffect(() => {
    ...
    const fetchItemData = async () => {
      try {
        const item = await getMyPendingItem(pendingItemId);
        setFormData(item);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await updateMyPendingItem(pendingItemId,formData);
