...
export default async function DownloadOBBPage({ params }: ArticlesPageProp) {
  ...
  try {
    const article = await getDownloadData(articleId, "original-apk");
        ...
        <div className="max-w-[648px] mx-auto p-10">
          ...
          <div className="flex flex-col items-center max-w-[480px] mx-auto">
            ...
            <p className="text-[1.25rem] text-center font-bold mb-9">
              ...
              <span>{article.versionOriginal}</span> free on Android
            </p>
            ...
            <Countdown fileSize={article.sizeFileOriginalAPK} link={article.linkOriginalAPK} />
          </div>
        </div>
        <div className="my-4">
          {isMobile ? (
