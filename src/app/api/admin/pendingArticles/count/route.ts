...
/**
 *  @method  GET
 *  @route   ~/api/admin/pendingArticles/count
 *  @desc    Get my Count pending Articles
...
export async function GET(request: NextRequest) {
  try {
    ...
    const pendingArticlesCount = userWithPendingCount?._count?.pendingArticles || 0;
