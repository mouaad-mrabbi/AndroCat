      ...
      <div className="px-7 max-[500px]:px-0 ">
        ...
        <div className=" relative mb-6 p-6 bg-[#1d1f21]">
          ...
          <button
            ...
            className="absolute p-3 inset-y-0 right-8 top-1/2 -translate-y-1/2
            text-white hover:text-green-500 text-xl transition-colors duration-500 "
          >
            <FaSearch />
          </button>
        </div>
