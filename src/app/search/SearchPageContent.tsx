        ...
        <div className="px-7 max-[500px]:px-0">
          ...
          <div className="relative mb-6 p-6 bg-[#1d1f21]">
            <input
              ...
              className="w-full border-none shadow-lg px-6 py-4 pr-14 text-base text-gray-900 outline-none focus:ring-transparent sm:text-lg sm:leading-7 sm:py-7 sm:px-8 sm:pr-[5rem] sm:h-[5.25rem] dark:bg-[#292c2f] dark:text-white dark:shadow-[0_8px_22px_rgba(0,0,0,0.25)]"
            />
            <button
